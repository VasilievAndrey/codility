...
public class GoodStringsTest {
    ...
    @ParameterizedTest
    public void test(String[] arr, String w, int exp) {
        assertEquals(exp, new GoodStrings().countCharacters(arr, w));
    }
